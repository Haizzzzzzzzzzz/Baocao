...
<html>
    <head>
        ...
        <title>JERSEY CUSTOM Shop</title>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="quantri.php"><span>JERSEY CUSTOM </span>Admin</a>
                    <ul class="user-menu">
            ...
            <ul class="nav menu">
                ...
                <li class="parent ">
                    <a href="quantri.php?page_layout=quanlytv">
                        <span data-toggle="collapse" href="#sub-item-1"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-male-user"></use></svg></span> Quản lý thành viên
                    </a>
                ...
                <li class="parent ">
                    <a href="quantri.php?page_layout=danhsachsp">
                        <span data-toggle="collapse" href="#sub-item-3"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-mobile-device"></use></svg></span> Quản lý sản phẩm
                    </a>
                ...
                <li class="parent ">
                    <a href="quantri.php?page_layout=dh">
                        <span data-toggle="collapse" href="#sub-item-6"><svg class="glyph stroked two messages"><use xlink:href="#stroked-bag"/></svg></span> Quản lý đơn hàng
                    </a>

                </li>
                <li class="parent ">
                    <a href="quantri.php?page_layout=quangcao">
                        <span data-toggle="collapse" href="#sub-item-5"><svg class="glyph stroked chevron-down"><use xlink:href="#stroked-landscape"></use></svg></span> Quản lý quảng cáo
                    </a>
                ...
                if(isset($_GET['page_layout'])){
                    switch ($_GET['page_layout']) {
                        ...
                        case 'thembl': include_once'./chucnang/binhluan/thembl.php';
                            break;
                        case 'dh': include_once'./chucnang/donhang/donhang.php';
                            break;
                        case 'suadh': include_once'./chucnang/donhang/suadh.php';
                            break;
                        case 'themdh': include_once'./chucnang/donhang/themdh.php';
                            break;    
